...
class Order(Base):
    ...
    first_name_customer = Column(String(150), unique=False, index=True, nullable=False)
    last_name_customer = Column(String(150), unique=False, index=True, nullable=False)
    email = Column(String(100), unique=False, index=True, nullable=False)
    phone = Column(String(20))
    congenital_disease = Column(String(100)) 
    note = Column(String(255))
    gender = Column(String(100))
    title_moo = Column(String(100))
    title_moo_number = Column(Integer)
